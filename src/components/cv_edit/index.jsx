    ...
    <>
      <Wrapper>
        ...
        <EducationEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.EducationEdit}
        />
        <LanguagesEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.LanguagesEdit}
        />
        <CoursesEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.CoursesEdit}
        />
        <CertificationsEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.CertificationsEdit}
        />
        <OrganisationEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.OrganisationEdit}
        />
        <PublicationsEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.PublicationsEdit}
        />
        <ProjectsEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
          visible={visible.ProjectsEdit}
        />
        <AwardEdit
          cvId={cvId}
          refreshCvData={refreshCvData}
